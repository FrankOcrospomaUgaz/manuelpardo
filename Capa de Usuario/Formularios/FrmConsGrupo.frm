...
Begin VB.Form FrmConsGrupo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   4695
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8130
   Icon            =   "FrmConsGrupo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Splits(0)._ColumnProps(9)=   "Column(1)._MinWidth=71106416"
      Splits.Count    =   1
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsGrupo.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsGrupo.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsGrupo.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsGrupo.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsGrupo.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsGrupo"
...
Private Const mstrformname As String = "Listado de Grupos"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetGrupo()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsGrupo_LoadData, Err.Source & " FrmConsGrupo : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantGrupo

On Error GoTo ErrHandler
    Set objform = New FrmMantGrupo
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsGrupo_AddNew, Err.Source & " FrmConsGrupo:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdGrupo = rstDataSource("IdGrupo")
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsGrupo_Update, Err.Source & " FrmConsGrupo:Update", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            Set objPersonal = CreateObject("Personal.clsPersonal")
            intIdGrupo = mrstDataSource("IdGrupo")
            strDescripcion = mrstDataSource("Descripcion")
            blnResult = objPersonal.DeleteGrupo(intIdGrupo, strMensajeError)
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Grupo", KEY_ACTION_DELETE, "Codigo " & Str(intIdGrupo) & " - Descripcion " & strDescripcion
            End If
            Set objPersonal = Nothing
            Screen.MousePointer = vbDefault
            LoadData
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsGrupo_Delete, Err.Source & " FrmConsGrupo:Delete", Err.Description)
End Function
