...
Begin VB.Form FrmBusqHorarioxDia 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   3615
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7500
   Icon            =   "FrmBusqHorarioxDia.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmBusqHorarioxDia.frx":0902
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmBusqHorarioxDia.frx":360C
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmBusqHorarioxDia"
...
Private Const mstrformname As String = "Consulta de Horario de Trabajador x Días"
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        Queries = True
        FrmConsHorarioxDia.intIdTrabajador = Me.intIdTrabajador
        FrmConsHorarioxDia.intIdCategoria = Me.intIdCategoria
        FrmConsHorarioxDia.intIdCargo = Me.intIdCargo
        FrmConsHorarioxDia.intIdArea = Me.intIdArea
        FrmConsHorarioxDia.intIdTipoHora = Me.intIdTipoHora
        FrmConsHorarioxDia.datFechaFin = Me.datFechaFin
        FrmConsHorarioxDia.datFechaInicio = Me.datFechaInicio
        FrmConsHorarioxDia.datHoraInicio = Me.datHoraInicio
        FrmConsHorarioxDia.datHoraFin = Me.datHoraFin
        FrmConsHorarioxDia.strModo = Me.strModo
        FrmConsHorarioxDia.ShowForm
        Unload Me
