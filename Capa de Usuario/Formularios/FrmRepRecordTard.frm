...
Begin VB.Form FrmRepRecordTard 
   ...
   EndProperty
   Icon            =   "FrmRepRecordTard.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRepRecordTard.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmRepRecordTard.frx":64EE
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmRepRecordTard"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const mstrformname As String = "Reporte de Tardanzas"
...
ErrHandler:
    Set objPersonal = Nothing
    Call ErrorMessage(FrmRepRecordTardanzas_Load, Err.Source & " FrmRepRecordTardanzas: Load", Err.Description)
End Sub
...
On Error GoTo ErrHandler
    ...
    If Me.OptDetalle.Value Then
        Set rstDataReport = objReport.GetRecordTardanzasD(Val(Me.TxtIdTrabajador.Text), intIdGrupo, Me.DTPInicio.Value, Me.DTPFin.Value)
        ...
        Else
            ...
            ShowMultiReport rstDataReport, "rptRepRecordDeTardanzasD", gaParametrosReport()
        End If
    'Imprime el reporte como listado
    Else
        Set rstDataReport = objReport.GetRecordTardanzasL(Val(Me.TxtIdTrabajador.Text), intIdGrupo, Me.DTPInicio.Value, Me.DTPFin.Value)
        Set objReport = Nothing
        If RecordsetReporteVacio(rstDataReport, strMensaje) Then
            MsgBox strMensaje, vbCritical, Me.Caption
        Else
            ...
            gaParametrosReport(4, 1) = "FechaFin"
            gaParametrosReport(4, 2) = CStr(Me.DTPFin.Value)
            ShowMultiReport rstDataReport, "rptRepRecordDeTardanzasL", gaParametrosReport()
        End If
    End If
...
Call ErrorMessage(FrmRepRecordTardanzas_Imprimir, Err.Source & " FrmRepRecordTardanzas:Imprimir", Err.Description)
End Sub
