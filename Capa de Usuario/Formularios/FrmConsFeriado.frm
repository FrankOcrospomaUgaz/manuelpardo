...
Begin VB.Form FrmConsFeriado 
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Columns(0).DataField=   "IdFeriado"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Feriado"
      Columns(1).DataField=   "FechaFeriado"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Remunerado"
      Columns(2).DataField=   "Remunerado"
      Columns(2).NumberFormat=   "Yes/No"
      ...
      Splits(0)._ColumnProps(5)=   "Column(0)._MinWidth=-8"
      Splits(0)._ColumnProps(6)=   "Column(1).Width=3149"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=3043"
      Splits(0)._ColumnProps(9)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(10)=   "Column(2).Width=2752"
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsFeriado.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsFeriado.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsFeriado.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsFeriado.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsFeriado.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmConsFeriado"
...
Private Const mstrformname As String = "Listado de Feriados"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetFeriado()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsFeriado_LoadData, Err.Source & " FrmConsFeriado : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantFeriado

On Error GoTo ErrHandler
    Set objform = New FrmMantFeriado
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsFeriado_AddNew, Err.Source & " FrmConsFeriado:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdFeriado = rstDataSource("IdFeriado")
        objform.dateFecha = rstDataSource("FechaFeriado")
        objform.blnRemunerado = rstDataSource("Remunerado")
        objform.ShowForm
        Set objform = Nothing
        Update = True
    End If
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsFeriado_Update, Err.Source & " FrmConsFeriado:Update", Err.Description)
End Function

Public Function Delete() As Boolean
Dim objPersonal As Object
Dim intIdFeriado As Integer
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            intIdFeriado = mrstDataSource("IdFeriado")
            datFechaFeriado = mrstDataSource("FechaFeriado")
            Set objPersonal = CreateObject("Personal.clsMovimientos")
            blnResult = objPersonal.DeleteFeriado(intIdFeriado, strMensajeError)
            Set objPersonal = Nothing
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Feriado", KEY_ACTION_DELETE, "Codigo " & Str(intIdFeriado) & " - Descripcion " & datFechaFeriado
            End If
            Screen.MousePointer = vbDefault
            LoadData
        End If
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsFeriado_Delete, Err.Source & " FrmConsFeriado:Delete", Err.Description)
End Function
