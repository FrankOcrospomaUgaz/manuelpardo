...
Begin VB.Form FrmConsCategoria 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9915
   Icon            =   "FrmConsCategoria.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Columns(0).DataField=   "IdCategoria"
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCategoria.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCategoria.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCategoria.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCategoria.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCategoria.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsCategoria"
...
Private Const mstrformname As String = "Listado de Categorias"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetCategoria()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsCategoria_LoadData, Err.Source & " FrmConsCategoria : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantCategoria

On Error GoTo ErrHandler
    Set objform = New FrmMantCategoria
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsCategoria_AddNew, Err.Source & " FrmConsCategoria:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdCategoria = rstDataSource("IdCategoria")
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsCategoria_Update, Err.Source & " FrmConsCategoria:Update", Err.Description)
End Function

Public Function Delete() As Boolean
Dim objPersonal As Object
Dim intIdCategoria As Integer
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            Set objPersonal = CreateObject("Personal.clsPersonal")
            intIdCategoria = mrstDataSource("IdCategoria")
            strDescripcion = mrstDataSource("Descripcion")
            blnResult = objPersonal.DeleteCategoria(intIdCategoria, strMensajeError)
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Categoria", KEY_ACTION_DELETE, "Codigo " & Str(intIdCategoria) & " - Descripcion " & strDescripcion
            End If
            Set objPersonal = Nothing
            Screen.MousePointer = vbDefault
            LoadData
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsCategoria_Delete, Err.Source & " FrmConsCategoria:Delete", Err.Description)
End Function
