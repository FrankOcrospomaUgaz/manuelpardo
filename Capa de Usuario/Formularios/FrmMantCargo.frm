VERSION 5.00
Begin VB.Form FrmMantCargo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   2160
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5445
   Icon            =   "FrmMantCargo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmMantCargo"
...
Private Const mstrformname As String = "Mantenimiento de Cargo"
Public Sub ShowForm()
...
On Error GoTo ErrHandler
    ...
    Else
        Unload Me
        If ActiveForm("FrmConsCargo") Then
            FrmConsCargo.LoadData
        End If
    End If
...
On Error GoTo ErrHandler
    ...
    Set rstPersonal = objPersonal.getcargo(Me.intIdCargo)
    Set objPersonal = Nothing
    If Not rstPersonal.EOF Then
        Me.TxtIdCargo.Text = rstPersonal("IdCargo")
...
ErrHandler:
    Set objPersonal = Nothing
    Set rstPersonal = Nothing
    Call ErrorMessage(FrmMantCargo_LoadData, Err.Source & " FrmMantCargo:LoadData", Err.Description)
End Sub
...
On Error GoTo ErrHandler
    Set objPersonal = CreateObject("Personal.clsPersonal")
    AddNew = objPersonal.AddNewCargo(Me.strDescripcion)
    Set objPersonal = Nothing
    If AddNew Then
        Bitacora "Cargo", KEY_ACTION_ADDNEW
    End If
...
Call ErrorMessage(FrmMantCargo_AddNew, Err.Source & " FrmMantCargo:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    Set objPersonal = CreateObject("Personal.clsPersonal")
    Update = objPersonal.UpdateCargo(Me.intIdCargo, Me.strDescripcion)
    Set objPersonal = Nothing
    If Update Then
        Bitacora "Cargo", KEY_ACTION_UPDATE, "Codigo " & Str(Me.intIdCargo) & " - Descripcion " & Me.strDescripcion
    End If
...
Call ErrorMessage(FrmMantCargo_Update, Err.Source & " FrmMantCargo:Update", Err.Description)
End Function
...
Public Function ValidateFields() As Boolean
    ...
    If Trim$(TxtDescripcion.Text) = "" Then
        ...
        Exit Function
    End If
    Me.intIdCargo = Val(Me.TxtIdCargo.Text)
