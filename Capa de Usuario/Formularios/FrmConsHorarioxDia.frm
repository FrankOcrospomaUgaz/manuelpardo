...
Begin VB.Form FrmConsHorarioxDia 
   ClientHeight    =   5715
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11055
   Icon            =   "FrmConsHorarioxDia.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5715
   ScaleWidth      =   11055
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsHorarioxDia.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsHorarioxDia.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsHorarioxDia.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsHorarioxDia.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsHorarioxDia.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Splits(0)._ColumnProps(7)=   "Column(1)._WidthInPix=3625"
      ...
      Splits(0)._ColumnProps(14)=   "Column(3).Width=2355"
      Splits(0)._ColumnProps(15)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(16)=   "Column(3)._WidthInPix=2249"
      Splits(0)._ColumnProps(17)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(18)=   "Column(4).Width=2196"
      Splits(0)._ColumnProps(19)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(20)=   "Column(4)._WidthInPix=2090"
      Splits(0)._ColumnProps(21)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(22)=   "Column(5).Width=1984"
      Splits(0)._ColumnProps(23)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(24)=   "Column(5)._WidthInPix=1879"
      Splits(0)._ColumnProps(25)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(26)=   "Column(6).Width=2699"
      Splits(0)._ColumnProps(27)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(28)=   "Column(6)._WidthInPix=2593"
   ...
   End
End
Attribute VB_Name = "FrmConsHorarioxDia"
...
Private Const mstrformname As String = "Listado de Horarios x Trabajador x Día"
...
Dim objform As FrmMantHorarioxDia

On Error GoTo ErrHandler
    Set objform = New FrmMantHorarioxDia
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            ...
            If Not blnResult Then
                ...
                Delete = False
            Else
                Bitacora "HorarioxTrabajadorxDía", KEY_ACTION_DELETE, "Codigo " & Str(intIdHorario)
            End If
            Screen.MousePointer = vbDefault
            LoadData
        End If
...
Public Function Finding() As Boolean
    Unload Me
    FrmBusqHorarioxDia.strModo = Me.strModo
