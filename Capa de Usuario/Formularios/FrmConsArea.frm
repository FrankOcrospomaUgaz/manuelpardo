...
Begin VB.Form FrmConsArea 
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Splits(0)._ColumnProps(10)=   "Column(1)._MinWidth=69927468"
      Splits.Count    =   1
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsArea.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsArea.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsArea.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsArea.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsArea.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsArea"
...
Private Const mstrformname As String = "Listado de Areas"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetArea()
...
Dim objform As FrmMantArea

On Error GoTo ErrHandler
    Set objform = New FrmMantArea
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsArea_AddNew, Err.Source & " FrmConsArea:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdArea = rstDataSource("IdArea")
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsArea_Update, Err.Source & " FrmConsArea:Update", Err.Description)
End Function

Public Function Delete() As Boolean
Dim objPersonal As Object
Dim intIdArea As Integer
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            Set objPersonal = CreateObject("Personal.clsPersonal")
            intIdArea = mrstDataSource("IdArea")
            strDescripcion = mrstDataSource("Descripcion")
            blnResult = objPersonal.DeleteArea(intIdArea, strMensajeError)
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Area", KEY_ACTION_DELETE, "Codigo " & Str(intIdArea) & " - Descripcion " & strDescripcion
            End If
            Set objPersonal = Nothing
            Screen.MousePointer = vbDefault
            LoadData
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsArea_Delete, Err.Source & " FrmConsArea:Delete", Err.Description)
End Function
