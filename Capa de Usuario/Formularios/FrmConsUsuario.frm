...
Begin VB.Form FrmConsUsuario 
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGAdministrar 
      ...
      Columns(0).DataField=   "IdUsuario"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Nombre"
      Columns(1).DataField=   "NombreUsuario"
      ...
      Splits(0)._ColumnProps(5)=   "Column(0)._MinWidth=167772160"
      Splits(0)._ColumnProps(6)=   "Column(1).Width=2752"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=2646"
      Splits(0)._ColumnProps(9)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(10)=   "Column(1)._MinWidth=101057928"
      Splits.Count    =   1
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsUsuario.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsUsuario.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsUsuario.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsUsuario.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsUsuario.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objSeguridad.GetUsuario()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objSeguridad = Nothing
    Call ErrorMessage(FrmConsUsuario_LoadData, Err.Source & " FrmConsUsuario : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantUsuario

On Error GoTo ErrHandler
    Set objform = New FrmMantUsuario
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsUsuario_AddNew, Err.Source & " FrmConsUsuario:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdUsuario = rstDataSource("IdUsuario")
        objform.strNombreUsuario = rstDataSource("NombreUsuario")
        objform.strClave = rstDataSource("Clave")
        objform.ShowForm
        Set objform = Nothing
        Update = True
    End If
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsUsuario_Update, Err.Source & " FrmConsUsuario:Update", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            intIdUsuario = mrstDataSource("IdUsuario")
            strNombreUsuario = mrstDataSource("NombreUsuario")
            Set objSeguridad = CreateObject("Personal.clsSeguridad")
            blnResult = objSeguridad.DeleteUsuario(intIdUsuario, strMensajeError)
            Set objSeguridad = Nothing
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Usuario", KEY_ACTION_DELETE, "Codigo " & Str(intIdUsuario) & " - NombreUsuario " & strNombreUsuario
            End If
            Screen.MousePointer = vbDefault
            LoadData
        End If
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsUsuario_Delete, Err.Source & " FrmConsUsuario:Delete", Err.Description)
End Function
