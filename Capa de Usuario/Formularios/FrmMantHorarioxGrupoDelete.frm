...
Begin VB.Form FrmMantHorarioxGrupoDelete 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8070
   Icon            =   "FrmMantHorarioxGrupoDelete.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame FraAcciones 
      ...
      Begin VB.CommandButton CmdCancelar 
         Height          =   510
         Left            =   2760
         Picture         =   "FrmMantHorarioxGrupoDelete.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton CmdEliminar 
         Height          =   495
         Left            =   1800
         Picture         =   "FrmMantHorarioxGrupoDelete.frx":0BD4
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.Frame FraFecha 
      ...
      Begin VB.CommandButton cmdConsultar 
         ...
         Height          =   450
         Left            =   6585
         Picture         =   "FrmMantHorarioxGrupoDelete.frx":0EDE
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "FrmMantHorarioxGrupoDelete"
...
Private Const mstrformname As String = "Mantenimiento de Eliminar Horarios por Grupo"
...
Public Function ValidateFields() As Boolean
    ...
    If intSeleccionados = 0 Then
        MsgBox "Debe seleccionar Horarios para Eliminar", vbInformation, mstrformname
        Exit Function
    Else
        If Not ValidateConsolidado Then
            MsgBox "Existe una Fecha Imposible de Eliminar, es posible que se haya consolidado", vbInformation, mstrformname
            Exit Function
        End If
...
intAcumulador = 0
    ...
    'rstDetalle.RecordCount <= 0 Then 'And Not rstDetalle.EOF Then 'Rvisar Aqui !!!!!!!!!!!
        MsgBox "No existen trabajadores en la lista ", vbInformation, mstrformname
