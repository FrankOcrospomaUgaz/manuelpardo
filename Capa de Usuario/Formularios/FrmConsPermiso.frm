...
Begin VB.Form FrmConsPermiso 
   ClientHeight    =   5370
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10995
   Icon            =   "FrmConsPermiso.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5370
   ScaleWidth      =   10995
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Columns(3).Caption=   "Remunerada"
      Columns(3).DataField=   "Remunerada"
      ...
      Splits(0)._ColumnProps(15)=   "Column(3).Width=4207"
      Splits(0)._ColumnProps(16)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(17)=   "Column(3)._WidthInPix=4101"
      ...
      _StyleDefs(40)  =   "Splits(0).Columns(2).Style:id=98,.parent=63"
      _StyleDefs(41)  =   "Splits(0).Columns(2).HeadingStyle:id=95,.parent=64"
      _StyleDefs(42)  =   "Splits(0).Columns(2).FooterStyle:id=96,.parent=65"
      _StyleDefs(43)  =   "Splits(0).Columns(2).EditorStyle:id=97,.parent=67"
      _StyleDefs(44)  =   "Splits(0).Columns(3).Style:id=102,.parent=63"
      _StyleDefs(45)  =   "Splits(0).Columns(3).HeadingStyle:id=99,.parent=64"
      _StyleDefs(46)  =   "Splits(0).Columns(3).FooterStyle:id=100,.parent=65"
      _StyleDefs(47)  =   "Splits(0).Columns(3).EditorStyle:id=101,.parent=67"
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":CD02
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsPermiso.frx":FA0C
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsPermiso"
...
Private Const mstrformname As String = "Listado de Permisos"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetJustificacion(, Me.intIdTrabajador, gintPermiso, _
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsPermiso_LoadData, Err.Source & " FrmConsPermiso : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantPermiso

On Error GoTo ErrHandler
    Set objform = New FrmMantPermiso
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsPermiso_AddNew, Err.Source & " FrmConsPermiso:AddNew", Err.Description)
End Function
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsPermiso_Delete, Err.Source & " FrmConsPermiso:Delete", Err.Description)
End Function

Public Function Finding() As Boolean
    Unload Me
    FrmBusqPermiso.strModo = Me.strModo
