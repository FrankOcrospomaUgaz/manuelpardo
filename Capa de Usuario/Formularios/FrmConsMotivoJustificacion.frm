...
Begin VB.Form FrmConsMotivoJustificacion 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9915
   Icon            =   "FrmConsMotivoJustificacion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Columns(0).DataField=   "IdMotivoJustificacion"
      ...
      Splits(0)._ColumnProps(9)=   "Column(1)._MinWidth=71065612"
      Splits.Count    =   1
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMotivoJustificacion.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMotivoJustificacion.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMotivoJustificacion.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMotivoJustificacion.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMotivoJustificacion.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsMotivoJustificacion"
...
Private Const mstrformname As String = "Listado de Motivo de Justificaciones"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetMotivoJustificacion()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsMotivoJustificacion_LoadData, Err.Source & " FrmConsMotivoJustificacion : LoadData", Err.Description)
End Sub
...
Private Sub TlbAcciones_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Key
        ...
        If rstDataSource("IdMotivoJustificacion") = gintFeriadoRemunerado Or rstDataSource("IdMotivoJustificacion") = gintFeriadoNoRemunerado Then
        MsgBox "Imposible modificar el registro Seleccionado, es del Sistema", vbInformation, mstrformname
        Else
            Update
        End If
...
Dim objform As FrmMantMotivoJustificacion

On Error GoTo ErrHandler
    Set objform = New FrmMantMotivoJustificacion
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsMotivoJustificacion_AddNew, Err.Source & " FrmConsMotivoJustificacion:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdMotivoJustificacion = rstDataSource("IdMotivoJustificacion")
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsMotivoJustificacion_Update, Err.Source & " FrmConsMotivoJustificacion:Update", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            Set objPersonal = CreateObject("Personal.clsPersonal")
            intIdMotivoJustificacion = mrstDataSource("IdMotivoJustificacion")
            strDescripcion = mrstDataSource("Descripcion")
            blnResult = objPersonal.DeleteMotivoJustificacion(intIdMotivoJustificacion, strMensajeError)
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "MotivoJustificacion", KEY_ACTION_DELETE, "Codigo " & Str(intIdMotivoJustificacion) & " - Descripcion " & strDescripcion
            End If
            Set objPersonal = Nothing
            Screen.MousePointer = vbDefault
            LoadData
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsMotivoJustificacion_Delete, Err.Source & " FrmConsMotivoJustificacion:Delete", Err.Description)
End Function
