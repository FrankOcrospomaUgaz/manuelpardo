...
Begin VB.Form FrmConsCargo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   5595
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9885
   Icon            =   "FrmConsCargo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Splits(0)._ColumnProps(5)=   "Column(0)._MinWidth=71099664"
      Splits(0)._ColumnProps(6)=   "Column(1).Width=2752"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=2646"
      Splits(0)._ColumnProps(9)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(10)=   "Column(1)._MinWidth=71091360"
      Splits.Count    =   1
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCargo.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCargo.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCargo.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCargo.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCargo.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsCargo"
...
Private Const mstrformname As String = "Listado de Cargos"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.getcargo()
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsCargo_LoadData, Err.Source & " FrmConsCargo : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantCargo

On Error GoTo ErrHandler
    Set objform = New FrmMantCargo
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsCargo_AddNew, Err.Source & " FrmConsCargo:AddNew", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        ...
        objform.intIdCargo = rstDataSource("IdCargo")
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsCargo_Update, Err.Source & " FrmConsCargo:Update", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Else
        If MsgBox(MSG_QUESTION_DELETE, vbOKCancel + vbQuestion, MSG_ACTION_DELETE & " - " & mstrformname) = 1 Then
            Screen.MousePointer = vbHourglass
            intIdCargo = mrstDataSource("IdCargo")
            strDescripcion = mrstDataSource("Descripcion")
            Set objPersonal = CreateObject("Personal.clsPersonal")
            blnResult = objPersonal.DeleteCargo(intIdCargo, strMensajeError)
            Set objPersonal = Nothing
            If Not blnResult Then
                MsgBox strMensajeError, vbCritical, mstrformname
                Delete = False
            Else
                Bitacora "Cargo", KEY_ACTION_DELETE, "Codigo " & Str(intIdCargo) & " - Descripcion " & strDescripcion
            End If
            Screen.MousePointer = vbDefault
            LoadData
        End If
...
ErrHandler:
    ...
    Screen.MousePointer = vbDefault
    Delete = False
    Call ErrorMessage(FrmConsCargo_Delete, Err.Source & " FrmConsCargo:Delete", Err.Description)
End Function
