...
Begin VB.Form FrmConsMarcaciones 
   Caption         =   "Consulta de Marcación"
   ClientHeight    =   5355
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7875
   Icon            =   "FrmConsMarcaciones.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5355
   ScaleWidth      =   7875
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Splits(0)._ColumnProps(5)=   "Column(1).Width=3678"
      Splits(0)._ColumnProps(6)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(7)=   "Column(1)._WidthInPix=3572"
      Splits(0)._ColumnProps(8)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(9)=   "Column(2).Width=3334"
      Splits(0)._ColumnProps(10)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(11)=   "Column(2)._WidthInPix=3228"
      Splits(0)._ColumnProps(12)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(13)=   "Column(3).Width=2143"
      Splits(0)._ColumnProps(14)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(15)=   "Column(3)._WidthInPix=2037"
      Splits(0)._ColumnProps(16)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(17)=   "Column(3)._MinWidth=77050736"
      Splits(0)._ColumnProps(18)=   "Column(4).Width=2752"
      ...
      Splits(0)._ColumnProps(22)=   "Column(4)._MinWidth=77050496"
      ...
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=204,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSComctlLib.Toolbar TlbAcciones 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Key             =   "[Modificar]"
               Object.ToolTipText     =   "Modificar Marcación"
               ImageIndex      =   2
            EndProperty
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMarcaciones.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMarcaciones.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMarcaciones.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMarcaciones.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsMarcaciones.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsMarcaciones"
...
Private Const mstrformname As String = "Listado de Marcaciones"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetMarcacionTrabajador(Me.intIdTrabajador, Me.datFechaInicio, Me.datFechaFin, Me.strApellido)
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsMarcaciones_LoadData, Err.Source & " FrmConsMarcacion : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantMarcaciones
...
On Error GoTo ErrHandler
    If Me.TdbgAdministrar.SelBookmarks.Count = 0 Then
        ...
        Update = False
    Else
        Set objform = New FrmMantMarcaciones
        objform.intAction = enumActions.Update
        objform.intIdTrabajador = rstDataSource("IdTrabajador")
        objform.intIdMarcacion = rstDataSource("IdMarcacion")
        objform.datFecha = rstDataSource("Fecha")
        objform.datHoraEntradaIdeal = IIf(IsNull(rstDataSource("HoraIngresoIdeal")), gdatHora_Nula, rstDataSource("HoraIngresoIdeal"))
        objform.datHoraEntradaReal = IIf(IsNull(rstDataSource("HoraIngresoReal")), gdatHora_Nula, rstDataSource("HoraIngresoReal"))
        objform.datHoraSalidaIdeal = IIf(IsNull(rstDataSource("HoraSalidaIdeal")), gdatHora_Nula, rstDataSource("HoraSalidaIdeal"))
        objform.datHoraSalidaReal = IIf(IsNull(rstDataSource("HoraSalidaReal")), gdatHora_Nula, rstDataSource("HoraSalidaReal"))
        objform.ShowForm
        Set objform = Nothing
        Update = True
    End If
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsMarcaciones_Update, Err.Source & " FrmConsMarcaciones:Update", Err.Description)
End Function

Public Function Finding() As Boolean
    Unload Me
    FrmBusqMarcacionTrabajador.strModo = Me.strModo
    FrmBusqMarcacionTrabajador.ShowForm
End Function
