...
Begin VB.Form FrmConsAccesoUsuario 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   5625
   ClientLeft      =   3840
   ClientTop       =   2925
   ClientWidth     =   9915
   Icon            =   "FrmConsAccesoUsuario.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGAdministrar 
      ...
      Splits(0)._ColumnProps(6)=   "Column(1).Width=4948"
      Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(8)=   "Column(1)._WidthInPix=4842"
      Splits(0)._ColumnProps(9)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(10)=   "Column(1)._MinWidth=97978496"
      Splits.Count    =   1
      ...
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=152,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsAccesoUsuario.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsAccesoUsuario.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsAccesoUsuario.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsAccesoUsuario.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsAccesoUsuario.frx":CD02
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsAccesoUsuario"
...
Private Const mstrformname As String = "Listado de Accesos de Usuario"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetUsuario(Me.intIdUsuario, Me.strNombreUsuario)
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsAccesoUsuario_LoadData, Err.Source & " FrmConsAccesoUsuario : LoadData", Err.Description)
End Sub
...
Dim objform As FrmMantAccesoUsuario

On Error GoTo ErrHandler
    Set objform = New FrmMantAccesoUsuario
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsAccesoUsuario_Update, Err.Source & " FrmConsAccesoUsuario :Update", Err.Description)
End Function

Public Function Finding() As Boolean
    Unload Me
    FrmBusqUsuario.strModo = Me.strModo
