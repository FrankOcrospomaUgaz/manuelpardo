...
Begin VB.Form FrmConsCompromisoMarcacion 
   ClientHeight    =   5625
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11730
   Icon            =   "FrmConsCompromisoMarcacion.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5625
   ScaleWidth      =   11730
   Begin TrueOleDBGrid70.TDBGrid TdbgAdministrar 
      ...
      Columns(4).Caption=   "IngresoIdeal"
      Columns(4).DataField=   "HoraIngresoIdeal"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "IngresoReal"
      Columns(5).DataField=   "HoraIngresoReal"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "SalidaIdeal"
      Columns(6).DataField=   "HoraSalidaIdeal"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "SalidaReal"
      Columns(7).DataField=   "HoraSalidaReal"
      ...
      Splits(0)._ColumnProps(15)=   "Column(2)._MinWidth=69551568"
      ...
      Splits(0)._ColumnProps(29)=   "Column(6).Width=1958"
      ...
      Splits(0)._ColumnProps(33)=   "Column(7).Width=2752"
      ...
      Begin MSComctlLib.Toolbar TlbAcciones 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Key             =   "[Nuevo]"
               Object.ToolTipText     =   "Generar compromisos de marcación"
               ImageIndex      =   1
            EndProperty
            ...
            BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Key             =   "[Modificar]"
               Object.ToolTipText     =   "Modifica registro"
               ImageIndex      =   2
            EndProperty
            ...
            BeginProperty Button5 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Key             =   "[ModificarGrupo]"
               Object.ToolTipText     =   "Modifica registros en grupo"
               ImageIndex      =   7
            EndProperty
            ...
            BeginProperty Button7 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Key             =   "[Eliminar]"
               Object.ToolTipText     =   "Eliminar Marcacion en Grupo"
               ImageIndex      =   6
            EndProperty
   ...
   Begin MSComctlLib.ImageList ImgLstAcciones 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":08CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":64EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":6DC6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":70E0
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":CD02
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":FA0C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConsCompromisoMarcacion.frx":102E6
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "FrmConsCompromisoMarcacion"
...
Private Const mstrformname As String = "Listado de Compromisos Marcacion por Trabajador"
...
On Error GoTo ErrHandler
    ...
    Set rstDataSource = objPersonal.GetCompromisoMarcacion(Me.intIdTrabajador, Me.intIdCategoria, _
                                        Me.intIdCargo, Me.intIdArea, Me.datFechaInicio, _
                                        Me.datFechaFin, Me.datHoraInicio, Me.datHoraFin, , Me.strApellido)
...
ErrHandler:
    Screen.MousePointer = vbDefault
    Set objPersonal = Nothing
    Call ErrorMessage(FrmConsCompromisoMarcacion_LoadData, Err.Source & " FrmConsCompromisoMarcacion : LoadData", Err.Description)
End Sub
...
Private Sub TlbAcciones_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Key
        ...
        Case KEY_ACTION_QUERY
            Finding
        Case KEY_ACTION_UPDATE_GROUP
            UpdateGrupo
    End Select
End Sub

Public Function AddNew() As Boolean
Dim objform As FrmMantCompromisoMarcacion

On Error GoTo ErrHandler
    Set objform = New FrmMantCompromisoMarcacion
...
ErrHandler:
    Set objform = Nothing
    AddNew = False
    Call ErrorMessage(FrmConsCompromisoMarcacion_AddNew, Err.Source & " FrmConsCompromisoMarcacion:AddNew", Err.Description)
End Function

Public Function Update() As Boolean
Dim objform As FrmMantCompromisoMarcacionUpdate
On Error GoTo ErrHandler
    Set objform = New FrmMantCompromisoMarcacionUpdate
    objform.intAction = enumActions.Update
    objform.lngIdMarcacion = rstDataSource("IdMarcacion")
    objform.ShowForm
    Set objform = Nothing
    Update = True
...
ErrHandler:
    Set objform = Nothing
    Update = False
    Call ErrorMessage(FrmConsCompromisoMarcacion_Update, Err.Source & " FrmConsCompromisoMarcacion:Update", Err.Description)
End Function

Public Function UpdateGrupo() As Boolean
Dim objform As FrmMantCompromisoMarcacionUpdateGrupo
On Error GoTo ErrHandler
    Set objform = New FrmMantCompromisoMarcacionUpdateGrupo
    objform.intAction = enumActions.UpdateGrupo
    objform.ShowForm
    Set objform = Nothing
    UpdateGrupo = True
...
Dim objform As FrmMantCompromisoMarcacionDelete

On Error GoTo ErrHandler
    Set objform = New FrmMantCompromisoMarcacionDelete
    objform.intAction = enumActions.Delete  ' falta
    objform.ShowForm
    Set objform = Nothing
    Delete = True
...
Public Function Finding() As Boolean
    Unload Me
    FrmBusqCompromisosMarcacion.strModo = Me.strModo
...
On Error GoTo ErrHandler
    Screen.MousePointer = vbHourglass
    Set rstDataReport = mrstDataSource.Clone
    ...
    Else
        ...
        gaParametrosReport(3, 2) = CStr(Me.datFechaInicio)
        gaParametrosReport(4, 1) = "FechaFin"
        gaParametrosReport(4, 2) = CStr(Me.datFechaFin)
        ShowMultiReport rstDataReport, "rptRepModificarMarcaciones", gaParametrosReport()
    End If
...
ErrHandler:
    Set rstDataReport = Nothing
    Screen.MousePointer = vbDefault
    Call ErrorMessage(FrmConsCompromisoMarcacion_Imprimir, Err.Source & " FrmConsCompromisoMarcacion : Imprimir", Err.Description)
End Function
