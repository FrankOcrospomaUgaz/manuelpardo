...
Begin VB.Form FrmMantPermiso 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   7770
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7575
   Icon            =   "FrmMantPermiso.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame FraFecha 
      ...
      Begin VB.CommandButton cmdConsultar 
         ...
         Height          =   450
         Left            =   6480
         Picture         =   "FrmMantPermiso.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.Frame FraAcciones 
      ...
      Begin VB.CommandButton CmdAceptar 
         Height          =   510
         Left            =   2565
         Picture         =   "FrmMantPermiso.frx":35CC
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton CmdCancelar 
         Height          =   510
         Left            =   3480
         Picture         =   "FrmMantPermiso.frx":460E
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGFaltas 
      ...
      Columns(2).Caption=   "Hora Inicio Permiso"
      Columns(2).DataField=   "HoraIngresoIdeal"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "Hora Fin Permiso"
      ...
      Columns(4).Caption=   "Permiso"
      Columns(4).DataField=   "Permiso"
      ...
      Splits(0)._ColumnProps(9)=   "Column(2).Width=3096"
      Splits(0)._ColumnProps(10)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(11)=   "Column(2)._WidthInPix=2990"
      Splits(0)._ColumnProps(12)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(13)=   "Column(3).Width=2884"
      Splits(0)._ColumnProps(14)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(15)=   "Column(3)._WidthInPix=2778"
      Splits(0)._ColumnProps(16)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(17)=   "Column(4).Width=3281"
      Splits(0)._ColumnProps(18)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(19)=   "Column(4)._WidthInPix=3175"
      ...
      _StyleDefs(40)  =   "Splits(0).Columns(2).Style:id=62,.parent=13"
      _StyleDefs(41)  =   "Splits(0).Columns(2).HeadingStyle:id=59,.parent=14"
      _StyleDefs(42)  =   "Splits(0).Columns(2).FooterStyle:id=60,.parent=15"
      _StyleDefs(43)  =   "Splits(0).Columns(2).EditorStyle:id=61,.parent=17"
   ...
   End
End
Attribute VB_Name = "FrmMantPermiso"
...
Private Const mstrformname As String = "Mantenimiento de Permisos"
...
Exit Sub
ErrHandler:
    Call ErrorMessage(FrmMantPermiso_ShowForm, Err.Source & " FrmMantPermiso:ShowForm", Err.Description)
End Sub
...
On Error GoTo ErrHandler
    ...
    Else
        Unload Me
        If ActiveForm("FrmConsPermiso") Then
            FrmConsPermiso.LoadData
        End If
    End If
...
On Error GoTo ErrHandler
    ...
    If ValidateFieldsConsultar Then
        ...
        Set rstDetalle = objPersonal.GetCampos("Entero As IdMarcacion, FechaMediana as Fecha, HoraLarga As HoraIngresoIdeal, HoraLarga as HoraSalidaIdeal, Boolean as Permiso")
...
ErrHandler:
    ...
    Call ErrorMessage(FrmMantPermiso_LoadData, Err.Source & " FrmMantPermiso:LoadData", Err.Description)
End Sub

Private Sub DtpFechaFin_Change()

If Me.DtpFechaFin.Value < Date Then
        MsgBox "Fecha no valida", vbInformation, mstrformname
        Me.DtpFechaFin.Value = Date
End If
...
On Error GoTo ErrHandler
    Set objPersonal = CreateObject("Personal.clsMovimientos")
    AddNew = objPersonal.AddNewPermiso(Me.datFecha, Me.strRemunerada, ArrayJustificadas, Me.strObservacion)
    Set objPersonal = Nothing
    If AddNew Then
...
Call ErrorMessage(FrmMantPermiso_AddNew, Err.Source & " FrmMantPermiso:AddNew", Err.Description)
End Function
...
Public Function ValidateFields() As Boolean
    ...
    Do While Not rstDetalle.EOF
        If rstDetalle!Permiso Then
            intSeleccionados = intSeleccionados + 1
        End If
        rstDetalle.MoveNext
    Loop
    If intSeleccionados = 0 Then
        MsgBox "Debe seleccionar marcaciones para permiso", vbInformation, mstrformname
        Exit Function
    Else
        If Not ValidateConsolidado Then
            MsgBox "Existe una Fecha Imposible de dar Permiso, es posible que se haya consolidado", vbInformation, mstrformname
            Exit Function
        End If
...
ErrHandler:
    ...
    Call ErrorMessage(FrmMantPermiso_ConfiguraArray, Err.Source & " FrmMantPermiso:ConfiguraArray", Err.Description)
End Function
...
Private Sub TDBGFaltas_AfterColEdit(ByVal ColIndex As Integer)

If Inicial > Me.TDBGFaltas.Columns(2).Value Then
    Me.TDBGFaltas.Columns(2).Value = Inicial
End If

If Final < Me.TDBGFaltas.Columns(3).Value Then
    Me.TDBGFaltas.Columns(3).Value = Final
End If


End Sub

Private Sub TDBGFaltas_BeforeColEdit(ByVal ColIndex As Integer, ByVal KeyAscii As Integer, Cancel As Integer)

Inicial = Me.TDBGFaltas.Columns(2).Value
Final = Me.TDBGFaltas.Columns(3).Value
...
If Me.TDBGFaltas.Col = 4 Then
    If Not (Me.rstDetalle.EOF And Me.rstDetalle.BOF) Then
        If Me.rstDetalle!Permiso Then
            Me.rstDetalle!Permiso = False
        Else
            Me.rstDetalle!Permiso = True
        End If
        rstDetalle.Update
    End If
End If
...
ErrHandler:
    Set objConsolidado = Nothing
    ValidateConsolidado = False
    Call ErrorMessage(FrmMantPermiso_ValidateConsolidado, Err.Source & " FrmMantPermiso:ValidateConsolidado", Err.Description)
End Function
