...
Begin VB.Form FrmMantJustificacionGrupo 
   BorderStyle     =   1  'Fixed Single
   ClientHeight    =   7920
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9405
   Icon            =   "FrmMantJustificacionGrupo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame FraAcciones 
      ...
      Begin VB.CommandButton CmdAceptar 
         Height          =   510
         Left            =   120
         Picture         =   "FrmMantJustificacionGrupo.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton CmdCancelar 
         Height          =   510
         Left            =   1080
         Picture         =   "FrmMantJustificacionGrupo.frx":190C
         Style           =   1  'Graphical
         TabIndex        =   22
   ...
   Begin VB.Frame FraFecha 
      ...
      Begin VB.CommandButton cmdConsultar 
         ...
         Height          =   450
         Left            =   8280
         Picture         =   "FrmMantJustificacionGrupo.frx":1C16
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.Frame FraDatos 
      ...
      Begin VB.TextBox TxtObservacion 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   4
         Text            =   "FrmMantJustificacionGrupo.frx":4910
         Top             =   1680
         Width           =   5370
      End
   ...
   Begin TrueOleDBGrid70.TDBGrid TDBGFaltas 
      ...
      Splits(0)._ColumnProps(5)=   "Column(1).Width=6853"
      Splits(0)._ColumnProps(6)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(7)=   "Column(1)._WidthInPix=6747"
      Splits(0)._ColumnProps(8)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(9)=   "Column(2).Width=2196"
      Splits(0)._ColumnProps(10)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(11)=   "Column(2)._WidthInPix=2090"
   ...
   End
End
Attribute VB_Name = "FrmMantJustificacionGrupo"
...
Private Const mstrformname As String = "Mantenimiento de Justificaciones por Grupo"
...
'            Me.OptNoRemunerada.Value = True
        Case enumActions.AddNewGrupo
            LoadData
            SettingControls enumActions.AddNewGrupo, Me
            Me.Caption = mstrformname & " - " & KEY_ACTION_ADDNEWGROUP
            Me.DtcMotivoJustificacion.BoundText = 0
            Me.DTPFecha.Value = Date
            Me.DtpFechaInicio.Value = Date
...
Exit Sub
ErrHandler:
    Call ErrorMessage(FrmMantJustificacionGrupo_ShowForm, Err.Source & " FrmMantJustificacionGrupo:ShowForm", Err.Description)
End Sub
...
On Error GoTo ErrHandler
    ...
    If ValidateFieldsConsultar Then
        ...
        Set rstDetalle = objPersonal.GetCampos("Entero As IdMarcacion, FechaMediana as Fecha, Texto As NombreCompleto, HoraLarga As HoraIngresoIdeal, HoraLarga as HoraSalidaIdeal, Boolean as Justificar")
        ...
        If rstFaltas.RecordCount > 0 Then
            ...
            Do While Not rstFaltas.EOF
                rstDetalle.AddNew
                rstDetalle!NombreCompleto = rstFaltas!NombreCompleto
...
ErrHandler:
    ...
    Call ErrorMessage(FrmMantJustificacionGrupo_LoadData, Err.Source & " FrmMantJustificacionGrupo:LoadData", Err.Description)
End Sub
...
FrmMensajeEspera.Refresh
    ...
    Else
        rstDetalle.MoveFirst
        Do While Not rstDetalle.EOF
            If Not Me.rstDetalle!Justificar Then
...
On Error GoTo ErrHandler
    ...
    Set objPersonal = CreateObject("Personal.clsMovimientos")
    'modificar para k justifike al grupo antes d llevar al pardo
    ...
    Set objPersonal = Nothing
    If AddNew Then
        Bitacora "Justificacion", KEY_ACTION_ADDNEWGROUP
    End If
...
Call ErrorMessage(FrmMantJustificacionGrupo_AddNew, Err.Source & " FrmMantJustificacionGrupo:AddNew", Err.Description)
End Function
...
ErrHandler:
    ...
    Call ErrorMessage(FrmMantJustificacionGrupo_ConfiguraArray, Err.Source & " FrmMantJustificacionGrupo:ConfiguraArray", Err.Description)
End Function
...
On Error GoTo ErrHandler
    ...
    Do While Not rstDetalle.EOF
        If rstDetalle!Justificar Then
            blnResult = objConsolidado.GetExisteConsolidado(rstDetalle!Fecha)
            If blnResult Then
...
ErrHandler:
    Set objConsolidado = Nothing
    ValidateConsolidado = False
    Call ErrorMessage(FrmMantJustificacionGrupo_ValidateConsolidado, Err.Source & " FrmMantJustificacionGrupo:ValidateConsolidado", Err.Description)
End Function
